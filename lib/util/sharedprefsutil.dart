...
class SharedPrefsUtil {
  // Keys
  static const String first_launch_key = 'fdragginator_first_launch';
  static const String price_conversion = 'fdragginator_price_conversion_pref';
  static const String auth_method = 'fdragginator_auth_method';
  static const String cur_currency = 'fdragginator_currency_pref';
  static const String cur_language = 'fdragginator_language_pref';
  static const String cur_theme = 'fdragginator_theme_pref';
  static const String firstcontact_added = 'fdragginator_first_c_added';
  static const String lock = 'fdragginator_lock_dev';
  static const String lock_timeout = 'fdragginator_lock_timeout';
  static const String has_shown_root_warning =
      'fdragginator_root_warn'; // If user has seen the root/jailbreak warning yet
  // For maximum pin attempts
  static const String pin_attempts = 'fdragginator_pin_attempts';
  static const String pin_lock_until = 'fdragginator_lock_duraton';
  // For certain keystore incompatible androids
  static const String use_legacy_storage = 'fdragginator_legacy_storage';

  static const String version_app = 'fdragginator_version_app';
