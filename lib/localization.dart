...
class AppLocalization {
  ...
  String get seedBackupInfo {
    return Intl.message(
        "Below is your seed. It is crucial that you backup your seed and never store it as plaintext or a screenshot.",
  ...
  String get welcomeText {
    return Intl.message(
        "Welcome to dragginator. To begin, you may create a new account or import an existing one.",
  ...
  String get insufficientTokenQuantity {
    return Intl.message("Insufficient Quantity in your account",
  ...
  String get unlockPin {
    return Intl.message("Enter PIN to Unlock dragginator",
        desc: '', name: 'unlockPin');
  }

  String get unlockBiometrics {
    return Intl.message("Authenticate to Unlock dragginator",
  ...
  String get encryptionFailedError {
    return Intl.message("Failed to set a App Password",
  ...
  String get exampleCardIntro {
    return Intl.message(
        "Welcome to my dragginator. Once you receive BIS, transactions will show up like this:",
  ...
  String get seedDescription {
    return Intl.message(
        "A seed bears the same information as a secret phrase, but in a machine-readable way. As long as you have one of them backed up, you'll have access to your eggs and your draggons.",
  ...
  String get secretInfo {
    return Intl.message(
        "In the next screen, you will see your secret phrase. It is a password to access your eggs, draggons and others stuffs. It is crucial that you back it up and never share it with anyone.",
  ...
  String get passwordNoLongerRequiredToOpenParagraph {
    return Intl.message(
        "You will not need a password to open dragginator anymore.",
        desc:
            'An info paragraph that tells the user a password will no longer be needed to open dragginator',
        name: 'passwordNoLongerRequiredToOpenParagraph');
  }

  String get createPasswordFirstParagraph {
    return Intl.message(
        "You can create a password to add additional security to your app.",
        desc:
  ...
  String get createPasswordSecondParagraph {
    return Intl.message(
        "Password is optional, and your app will be protected with your PIN or biometrics regardless.",
        desc:
  ...
  String get requireAPasswordToOpenHeader {
    return Intl.message("Require a password to open dragginator?",
        desc:
            'A paragraph that asks the users if they would like a password to be required to open dragginator.',
  ...
  String get connectingHeader {
    return Intl.message("Connecting",
        desc:
            'A header to let the user now that dragginator is currently connecting to (or loading) live chat.',
